...
import com.glocks.dao.MessageConfigurationDb;
import com.glocks.dao.PolicyBreachNotification;
...
public class EdrP3Process {
    ...
    private static void addCDRInProfileWithRule(String operator, Connection conn, ArrayList<Rule> rulelist,
        ...
        try {
            ...
            new Util().raiseAnAlertJar("alert1111", "" + e.getLocalizedMessage(), "P3_" + operator + "_" + source, 0);
